...
def parse_args():
    ...
    parser.add_argument("--persistent_dir",type=str,default=os.environ["SAGEMAKER_MANAGED_WARMPOOL_CACHE_DIRECTORY"])
    ...
    parser.add_argument("--transformer_layer_cls_to_wrap",type=str,default=None)
